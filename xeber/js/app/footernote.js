$(document).ready(function () {
    ...
    var posts = firebase.database().ref('/footernote')
    ...
    posts.on('value', function (res) {
      ...
      Object.keys(data).map(key => {
        ...
        var td1 = $('<td>').html(`<textarea class='textareaedit'> ${data[key].footernote} </textarea><button class='btn btn-warning btn-block editBtn'>Edit</button>`)
